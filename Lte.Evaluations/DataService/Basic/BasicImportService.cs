...
namespace Lte.Evaluations.DataService.Basic
{
    public class BasicImportService
    {
        ...
        public int ImportConstructions(string path)
        {
            ...
            return
                _constructionInformation
                    .Import<IConstructionInformationRepository, ConstructionInformation, ConstructionExcel>(excels);
        }
        ...
        public int ImportStationRrus(string path)
        {
            ...
            return
                _stationRruRepository
                    .Import<IStationRruRepository, StationRru, StationRruExcel>(excels);
        }
