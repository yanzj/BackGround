...
{
    [AutoMapFrom(typeof(TownHourPrbView))]
    [TypeDoc("区忙时PRB利用率统计")]
    public class DistrictHourPrbView : ICityDistrict, IStatDate
    {
        ...
        public static DistrictHourPrbView ConstructView(TownHourPrbView townView)
        {
            return townView.MapTo<DistrictHourPrbView>();
        }
    }
}
