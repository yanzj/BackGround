...
namespace Lte.Domain.LinqToExcel.Entities
{
    public class ProjectorBuildingExpressionTreeVisitor : ExpressionTreeVisitor
    {
        ...
        private static readonly MethodInfo SGetObjectGenericMethodDefinition
        ...
        {
            var getObjectMethod = SGetObjectGenericMethodDefinition.MakeGenericMethod(expression.Type);
