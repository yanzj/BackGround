...
namespace Lte.Domain.LinqToExcel
{
    public class ExcelQueryFactory : IExcelQueryFactory
    {
        ...
        /// </summary>
        public ExcelDatabaseEngine DatabaseEngine { get; set; }
        ...
        /// <param name="property">Class property to map to</param>
        /// <param name="column">Worksheet column name to map from</param>
        /// <param name="transformation">Lambda expression that transforms the 
        /// original string value to the desired property value</param>
        public void AddMapping<TSheetData>(Expression<Func<TSheetData, object>> property, string column, 
        ...
        /// <param name="transformation">Lambda expression that transforms the original string value to 
        /// the desired property value</param>
        /// <example>
        /// AddTransformation{Person}(p => p.IsActive, x => x == "Y");
        /// AddTransformation{Person}(p => p.IsYoung, x => DateTime.Parse(x) > new DateTime(2000, 1, 1));
        /// </example>
        public void AddTransformation<TSheetData>(Expression<Func<TSheetData, object>> property, 
            Func<string, object> transformation)
        {
        ...
        public ExcelQueryConstructorArgs GetConstructorArgs()
        {
        ...
        /// Enables Linq queries against an Excel worksheet
        /// </summary>
        public ExcelQueryable<ExcelRow> Worksheet()
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())));
        }
        ...
        /// </summary>
        /// <param name="worksheetName">Name of the worksheet</param>
        public ExcelQueryable<ExcelRow> Worksheet(string worksheetName)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// </summary>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        public ExcelQueryable<ExcelRow> Worksheet(int worksheetIndex)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        public ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetName">Name of the worksheet</param>
        public ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange, string worksheetName)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        public ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange, int worksheetIndex)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetName">Name of the worksheet</param>
        public ExcelQueryable<TSheetData> WorksheetRange<TSheetData>(string startRange, 
            string endRange, string worksheetName)
        {
            return new ExcelQueryable<TSheetData>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// </summary>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader()
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
                    NoHeader = true
                }));
        ...
        /// </summary>
        /// <param name="worksheetName">Name of the worksheet</param>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader(string worksheetName)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// </summary>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader(int worksheetIndex)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="startRange">Upper left cell name of the range (eg 'B2')</param>
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, string endRange)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetName">Name of the worksheet</param>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, 
            string endRange, string worksheetName)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        public ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, 
            string endRange, int worksheetIndex)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// </summary>
        /// <param name="namedRangeName">Name of the workbook-scope named range</param>
        public ExcelQueryable<ExcelRow> NamedRange(string namedRangeName)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="worksheetName">Name of the worksheet</param>
        /// <param name="namedRangeName">Name of the worksheet-scope named range</param>
        public ExcelQueryable<ExcelRow> NamedRange(string worksheetName, string namedRangeName)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        /// <param name="namedRangeName">Name of the worksheet-scope named range</param>
        public ExcelQueryable<ExcelRow> NamedRange(int worksheetIndex, string namedRangeName)
        {
            return new ExcelQueryable<ExcelRow>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// </summary>
        /// <param name="namedRangeName">Name of the workbook-scope named range</param>
        public ExcelQueryable<ExcelRowNoHeader> NamedRangeNoHeader(string namedRangeName)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        /// <param name="namedRangeName">Name of the worksheet-scope named range</param>
        public ExcelQueryable<ExcelRowNoHeader> NamedRangeNoHeader(int worksheetIndex, string namedRangeName)
        {
            return new ExcelQueryable<ExcelRowNoHeader>(PersistQueryArgs(
                new ExcelQueryArgs(GetConstructorArgs())
                {
        ...
        /// <param name="worksheetName">Name of the worksheet</param>
        /// <param name="fileName">Full path to the Excel spreadsheet</param>
        public static ExcelQueryable<ExcelRow> Worksheet(string worksheetName, string fileName)
        {
            return new ExcelQueryable<ExcelRow>(
                new ExcelQueryArgs(
                    new ExcelQueryConstructorArgs { FileName = fileName })
                {
                    WorksheetName = worksheetName
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        /// <param name="fileName">Full path to the Excel spreadsheet</param>
        public static ExcelQueryable<ExcelRow> Worksheet(int worksheetIndex, string fileName)
        {
            return new ExcelQueryable<ExcelRow>(
                new ExcelQueryArgs(
                    new ExcelQueryConstructorArgs { FileName = fileName })
