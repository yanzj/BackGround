...
namespace Lte.Domain.LinqToExcel
{
    public interface IExcelQueryFactory : IDisposable
    {
        ...
        /// </summary>
        ExcelDatabaseEngine DatabaseEngine { get; set; }
        ...
        /// Enables Linq queries against an Excel worksheet
        /// </summary>
        ExcelQueryable<ExcelRow> Worksheet();

        /// <summary>
        /// Enables Linq queries against an Excel worksheet
        /// </summary>
        /// <param name="worksheetName">Name of the worksheet</param>
        ExcelQueryable<ExcelRow> Worksheet(string worksheetName);

        /// <summary>
        /// Enables Linq queries against an Excel worksheet
        /// </summary>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        ExcelQueryable<ExcelRow> Worksheet(int worksheetIndex);
        ...
        /// <param name="startRange">Upper left cell name of the range (eg 'B2')</param>
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange);
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetName">Name of the worksheet</param>
        ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange, string worksheetName);
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        ExcelQueryable<ExcelRow> WorksheetRange(string startRange, string endRange, int worksheetIndex);

        /// <summary>
        /// Enables Linq queries against an Excel worksheet that does not have a header row
        /// </summary>
        ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader();

        /// <summary>
        /// Enables Linq queries against an Excel worksheet that does not have a header row
        /// </summary>
        /// <param name="worksheetName">Name of the worksheet</param>
        ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader(string worksheetName);

        /// <summary>
        /// Enables Linq queries against an Excel worksheet that does not have a header row
        /// </summary>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        ExcelQueryable<ExcelRowNoHeader> WorksheetNoHeader(int worksheetIndex);
        ...
        /// <param name="startRange">Upper left cell name of the range (eg 'B2')</param>
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, string endRange);
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetName">Name of the worksheet</param>
        ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, string endRange, string worksheetName);
        ...
        /// <param name="endRange">Bottom right cell name of the range (eg 'D4')</param>
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        ExcelQueryable<ExcelRowNoHeader> WorksheetRangeNoHeader(string startRange, string endRange, int worksheetIndex);
        ...
        /// </summary>
        /// <param name="namedRangeName">Name of the workbook-scope named range</param>
        ExcelQueryable<ExcelRow> NamedRange(string namedRangeName);
        ...
        /// <param name="worksheetName">Name of the worksheet</param>
        /// <param name="namedRangeName">Name of the named range</param>
        ExcelQueryable<ExcelRow> NamedRange(string worksheetName, string namedRangeName);
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        /// <param name="namedRangeName">Name of the named range</param>
        ExcelQueryable<ExcelRow> NamedRange(int worksheetIndex, string namedRangeName);

        /// <summary>
        /// Enables Linq queries against a workbook-scope named range that does not have a header row
        /// </summary>
        /// <param name="namedRangeName">Name of the workbook-scope named range</param>
        ExcelQueryable<ExcelRowNoHeader> NamedRangeNoHeader(string namedRangeName);
        ...
        /// <param name="worksheetName">Name of the worksheet</param>
        /// <param name="namedRangeName">Name of the named range</param>
        ExcelQueryable<ExcelRowNoHeader> NamedRangeNoHeader(string worksheetName, string namedRangeName);
        ...
        /// <param name="worksheetIndex">Worksheet index ordered by name, not position in the workbook</param>
        /// <param name="namedRangeName">Name of the named range</param>
        ExcelQueryable<ExcelRowNoHeader> NamedRangeNoHeader(int worksheetIndex, string namedRangeName);
