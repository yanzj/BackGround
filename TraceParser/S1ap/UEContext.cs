...
{
    [Serializable]
    public class UEContextModificationFailure
    {
        ...
        public class PerDecoder
        {
            ...
            public UEContextModificationFailure Decode(BitArrayInputStream input)
            {
    ...
    [Serializable]
    public class UEContextModificationRequest
    {
        public void InitDefaults()
        {
        }
        ...
        public class PerDecoder
        {
            ...
            public UEContextModificationRequest Decode(BitArrayInputStream input)
            {
    ...
    [Serializable]
    public class UEContextModificationResponse
    {
        public void InitDefaults()
        {
        }
        ...
        public class PerDecoder
        {
            ...
            public UEContextModificationResponse Decode(BitArrayInputStream input)
            {
    ...
    [Serializable]
    public class UEContextReleaseCommand
    {
        public void InitDefaults()
        {
        }
        ...
        public class PerDecoder
        {
            ...
            public UEContextReleaseCommand Decode(BitArrayInputStream input)
            {
    ...
    [Serializable]
    public class UEContextReleaseComplete
    {
        public void InitDefaults()
        {
        }
    ...
    [Serializable]
    public class UEContextReleaseRequest
    {
        public void InitDefaults()
        {
        }
        ...
        public class PerDecoder
        {
            ...
            public UEContextReleaseRequest Decode(BitArrayInputStream input)
            {
