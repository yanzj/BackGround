...
namespace TraceParser.S1ap
{
    ...
    public class S1SetupRequest
    {
        ...
        public class PerDecoder
        {
            ...
            public S1SetupRequest Decode(BitArrayInputStream input)
            {
                S1SetupRequest request = new S1SetupRequest();
    ...
    public class S1SetupResponse
    {
        ...
        public class PerDecoder
        {
            ...
            public S1SetupResponse Decode(BitArrayInputStream input)
            {
                S1SetupResponse response = new S1SetupResponse();
