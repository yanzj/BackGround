...
{
    [ApiControl("掌上优信号详单查询控制器")]
    [ApiGroup("测试")]
    public class ZhangshangyouCoverageController : ApiController
    {
        private readonly ZhangshangyouCoverageService _service;

        public ZhangshangyouCoverageController(ZhangshangyouCoverageService service)
        {
            _service = service;
        }
        ...
        [HttpGet]
        public IEnumerable<ZhangshangyouCoverageView> Get(DateTime begin, DateTime end,
        ...
        [HttpGet]
        public IEnumerable<ZhangshangyouCoverageView> GetLte(DateTime begin, DateTime end,
        ...
        [HttpGet]
        public IEnumerable<ZhangshangyouCoverageView> GetCdma(DateTime begin, DateTime end,
